...
curl https://raw.githubusercontent.com/francedmr/FreeDMR-Docker/main/logo.png -o /var/www/html/img/logo.png
...
ANNOUNCEMENT_LANGUAGES: fr_FR_2
SERVER_ID: 9990
DATA_GATEWAY: False
